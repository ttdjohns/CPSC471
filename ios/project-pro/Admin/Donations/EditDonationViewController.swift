...
class EditDonationTableViewController: UITableViewController {
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		amountTextField.text = "\(donation.amount)"
		causeTextField.text = "\(donation.causeID)"
		donorTextField.text = "\(donation.donorID)"
	}
	...
	@IBAction func doneButtonDidPress(_ sender: Any) {
		let url = URL(string: Endpoint.editDonation)!
		...
		do {
			...
			parameters["Donation_ID"] = donation.id
