//
//  AddStrengthTableViewController.swift
//  project-pro
//
...
class AddStrengthTableViewController: UITableViewController {
	...
	@IBAction func doneButtonDidPress(_ sender: Any) {
		let url = URL(string: Endpoint.addStrength)!
